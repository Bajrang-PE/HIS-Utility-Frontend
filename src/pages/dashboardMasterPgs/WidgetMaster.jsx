...
const WidgetMaster = () => {
  ...
  const [radioValues, setRadioValues] = useState({
    ...
    isHeadingFixed: 'yes',
    isLastRowTotal: 'yes',
    isCardViewMobile: true,
    isShowPrntHeadChild: true,
    isShowPrntParamsChild: true,
    printPdfIn: 'landscape',
    pdfTheme: 'grid',
    isPdfHeadReqAllPgs: true,
    showFilterDtlsInPdf: true,
    isReportByJsPdfPlug: true,
    isReportPrintDtReq: true,
    isGlobalHeaderReq: true,
    isTableBorderReq: true,
    isPositiveWidget: true,
    isDirectDownload: true,
    isPopupBasedReq: true,
    isTreeChildReq: true,
    treeChildDataBy: "query",
    dataDisplay: "horizontal",
    isDataTblReqTree: true,
    isPaginationReqTree: true,
    isSearchReqTree: true,
  })
    ...
    <>
      ...
      <div className='main-master-page'>
        <div className='row w-100 m-0'>
          ...
          <div className='col-sm-6 p-0'>
            <TabNav isTabNav={true} tabNavData={tabNavMenus} setTabIndex={setTabIndex} />
          </div>
        </div>
