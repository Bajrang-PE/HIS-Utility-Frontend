...
const MapDash = () => {
  ...
  // useEffect(() => {
  //   if (!Highcharts.Map) {
  //     import("highcharts/modules/map").then((mod) => mod.default(Highcharts));
  //   }
  //   if (!Highcharts.drilldown) {
  //     import("highcharts/modules/drilldown").then((mod) => mod.default(Highcharts));
  //   }
  //   if (!Highcharts.exporting) {
  //     import("highcharts/modules/exporting").then((mod) => mod.default(Highcharts));
  //   }
  //   if (!Highcharts.exportData) {
  //     import("highcharts/modules/export-data").then((mod) => mod.default(Highcharts));
  //   }
  //   if (!Highcharts["highcharts-more"]) {
  //     import("highcharts/highcharts-more").then((mod) => mod.default(Highcharts));
  //   }
  // }, []);
